...
export const addResultsSuccess = createAction('[Questions] Add success', props<{ results: QuestionResult[] }>());
export const addResultsFailed = createAction('[Questions] Add failed');
